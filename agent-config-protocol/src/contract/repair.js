...
export const CONFIG_NODE_RULES = Object.freeze([
  ...
  systemOwnedRule("attachments.maxFileCount"),
  systemOwnedRule("attachments.maxFileSizeBytes"),
  systemOwnedRule("attachments.maxTotalSizeBytes"),
  systemOwnedRule("attachments.allowedExtensions"),
  systemOwnedRule("attachments.allowedMimeTypes"),
