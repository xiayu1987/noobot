...
.sidebar {
  ...
  box-shadow: none;
  transition:
    width var(--noobot-duration-slow) cubic-bezier(0.4, 0, 0.2, 1),
    min-width var(--noobot-duration-slow) cubic-bezier(0.4, 0, 0.2, 1),
    transform var(--noobot-duration-slow) cubic-bezier(0.4, 0, 0.2, 1);
}
