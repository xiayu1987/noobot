...
import { backendState, sendStart, settleTerminal } from "./turnRuntimeRegistryTestFixtures.js";
...
it("tombstones a confirmed deletion and rejects late replay for the same Session Turn", () => {
  ...
  expect(confirmTurnRuntimeDeletion(registry, "deleted-turn", { sessionId: "s1" }).applied).toBe(
    true,
  );
  expect(
