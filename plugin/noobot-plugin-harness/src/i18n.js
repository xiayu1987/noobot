...
const I18N_RUNTIME_LABELS = Object.freeze({
  ...
  [LOCALE.EN_US]: Object.freeze({
    ...
    guidanceAnalysisPromptGoal:
      "Based on the current execution result, use one natural, plain sentence to explain the current progress so it is immediately clear what has been done, whether there are new problems, questions, or risks, and what should be done next. Do not repeat the previous round; avoid fixed templates, bullet points, or mechanical phrasing.",
    dynamicPolicyPromptProtocolInstruction:
