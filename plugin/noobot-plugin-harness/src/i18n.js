...
const I18N_RUNTIME_LABELS = Object.freeze({
  [LOCALE.ZH_CN]: Object.freeze({
    ...
    guidanceAnalysisPromptGoal:
      "请根据当前执行结果，用一句自然、通俗的话概括当前进展，让人一眼就知道现在做到哪了、有没有新的问题情况疑点风险、接下来该做什么。只做分析和建议，不要自己执行任何动作。避免固定模板、分点或机械套话。",
    dynamicPolicyPromptProtocolInstruction:
  ...
  [LOCALE.EN_US]: Object.freeze({
    ...
    guidanceAnalysisPromptGoal:
      "Based on the current execution result, use one natural, plain sentence to explain the current progress so it is immediately clear what has been done, whether there are new problems, questions, or risks, and what should be done next. Only analyze and suggest; do not execute any action yourself. Do not repeat the previous round; avoid fixed templates, bullet points, or mechanical phrasing.",
    dynamicPolicyPromptProtocolInstruction:
