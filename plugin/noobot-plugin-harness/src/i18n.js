...
const I18N_RUNTIME_LABELS = Object.freeze({
  [LOCALE.ZH_CN]: Object.freeze({
    ...
    guidanceAnalysisPromptGoal:
      "请分析当前该做什么、发现了什么问题、疑点、应如何解决。",
    guidanceAnalysisOutputConstraint:
      "只用一句话概括，覆盖下一步、问题、疑点和解决方式。",
    dynamicPolicyPromptProtocolInstruction:
  ...
  [LOCALE.EN_US]: Object.freeze({
    ...
    guidanceAnalysisPromptGoal:
      "Analyze what should be done now, what problem is visible, what doubts remain, and how to resolve them.",
    guidanceAnalysisOutputConstraint:
      "Use exactly one concise sentence covering the next step, the problem, the doubt, and the fix.",
    dynamicPolicyPromptProtocolInstruction:
