...
export function resolveRefinementTargetMainSteps(bucket = {}, state = {}) {
...
export function applyRevisedPlanFromText(
  ctx = {},
  text = "",
...
export function buildPlanningRefinementPrompt(locale = LOCALE.ZH_CN, bucket = {}, state = {}, summaryText = "") {
...
export function buildNextPhaseRelayContent(bucket = {}, locale = LOCALE.ZH_CN, stage = "revision") {
