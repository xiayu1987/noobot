...
const HARNESS_FRONTEND_MESSAGES = Object.freeze({
  "zh-CN": Object.freeze({
    ...
    modelExtension: Object.freeze({
      ...
      summaryTurns: "Harness 小结轮次",
      planUpdateTurns: "计划更新轮次",
      phaseAcceptanceTurns: "阶段验收轮次",
  ...
  "en-US": Object.freeze({
    ...
    modelExtension: Object.freeze({
      ...
      summaryTurns: "Harness summary turns",
      planUpdateTurns: "Plan update turns",
      phaseAcceptanceTurns: "Phase acceptance turns",
