...
export default {
  ...
  "tools.patch_file.fieldPatch": "Patch content; read the file first and use exact context; unified diff counts need not be hand-computed. Patch paths resolve from the current workspace root; pass root when target files are under a child directory.",
  ...
  "tools.patch_file.fieldRoot": "Patch root directory (optional, relative to workspace); when target files are under a child directory, pass that child directory path as root.",
