...
export default {
  ...
  "tools.risk.criticalConfirmation": (params = {}) => [
    "A critical-risk tool operation requires your explicit confirmation.",
  ...
  "tools.risk.criticalConfirmationUnavailable": "Critical-risk operations require confirmation, but the user interaction channel is unavailable.",
  "tools.risk.criticalCancelled": "The critical-risk operation was not confirmed and was cancelled.",
