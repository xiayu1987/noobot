...
export default {
  ...
  "tools.patch_file.fieldPatchPathHintHost": "Host view: relative paths use the default rootDirectory; absolute paths must stay inside allowedRoots.",
  "tools.patch_file.fieldPatchPathHintSuperHost": "Host view, super user: relative paths use the default rootDirectory; Windows/macOS/Linux host absolute paths are allowed.",
