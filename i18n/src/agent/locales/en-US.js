...
export default {
  ...
  "tools.patch_file.description": "Apply file patches, supports apply_patch/unified_diff.",
  "tools.patch_file.fieldFormat": "Patch format.",
  "tools.patch_file.fieldPatch": "Patch content.",
  "tools.patch_file.fieldStrip": "Path strip level for unified_diff.",
