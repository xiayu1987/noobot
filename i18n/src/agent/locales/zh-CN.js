...
export default {
  ...
  "tools.patch_file.fieldPatch": "补丁内容；推荐先读文件，用精确上下文。unified diff 可使用标准 @@ -行号 +行号 @@，也兼容仅 @@ 的搜索式 hunk。补丁路径基于当前 workspace 根解析；目标在子项目时可传 root 或包含子项目目录。",
  "tools.patch_file.fieldStrip": "diff 路径层级提示；默认兼容 a/、b/、无前缀和 /project 等常见路径，不确定可省略。",
  "tools.patch_file.fieldRoot": "补丁根目录（可选，workspace 相对路径）；目标文件都在某个子项目下时，传该子项目路径作为 root。",
