...
export default {
  ...
  "tools.patch_file.fieldPatchPathHintHost": "Host 视角：相对路径基于默认根目录 rootDirectory；绝对路径必须位于允许根 allowedRoots 内。",
  "tools.patch_file.fieldPatchPathHintSuperHost": "Host 视角，超级管理员：相对路径基于默认根目录 rootDirectory；可使用 Windows/macOS/Linux host 绝对路径。",
