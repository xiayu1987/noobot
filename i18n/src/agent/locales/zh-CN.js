...
export default {
  ...
  "tools.patch_file.fieldPatch": "补丁内容；推荐先读文件，用精确上下文；不必手算 unified diff 行数。补丁路径基于当前 workspace 根解析；目标文件在子目录时可传 root。",
  "tools.patch_file.fieldStrip": "diff 路径层级；默认 strip=1 去掉 a/、b/，并兼容 /project 等虚拟前缀。",
  "tools.patch_file.fieldRoot": "补丁根目录（可选，workspace 相对路径）；目标文件都在某个子目录下时，传该子目录路径作为 root。",
