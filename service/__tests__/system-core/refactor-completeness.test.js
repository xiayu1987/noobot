...
} from '../../system-core/session/entities.js';
...
} from '../../system-core/model/resolver/index.js';
...
import {
  ...
  getEnabledProviders,
  firstEnabledAlias
} from '../../system-core/model/provider/resolver.js';
...
// 动态导入 ContextBuilder
const { ContextBuilder } = await import('../../system-core/bot-manage/session/context-builder.js');
