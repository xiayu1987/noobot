...
const TEXT = {
  zh: {
    ...
    chooseFormatHint: "请输入 openai_compatible",
    ...
    stepModelFormat: "第三步：对话模型 format (openai_compatible)",
    ...
    errFormatInvalid: "format 仅支持 openai_compatible",
  ...
  en: {
    ...
    chooseFormatHint: "Enter openai_compatible",
    ...
    stepModelFormat: "Step 3: model format (openai_compatible)",
    ...
    errFormatInvalid: "format must be openai_compatible",
